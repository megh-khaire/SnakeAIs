...
class Game:
    ...
    # Function to select a direction for the snake to move using steepest ascent hill climbing (selection of best neighbor)
    def hill_climbing(self):
        ...
        # Checking if the best neighbor is better than current state
        self.head.h = self.calculate_h(self.head)
        # Climbing the hill if best neighbor is better
        if neighbor.h < self.head.h:
